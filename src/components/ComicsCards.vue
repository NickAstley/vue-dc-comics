        ...
        <div class="bg-secondary">
            <div class="container">
                ...
                <div class="row row-cols-6 gy-5">
                    <div v-for="comic in comics" :key="comic.series" @click="clickedComicImg = comic[`thumb`]">
                        <ComicCard :card-img="comic.thumb" :card-title="comic.series" :card-price="comic.price" :card-type="comic.type"/>
                    </div>
                </div>
